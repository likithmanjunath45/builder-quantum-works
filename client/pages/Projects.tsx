  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive navigation application designed to streamline campus movement for students and visitors. The app features real-time route optimization, accessibility mapping, and social integration to foster campus community engagement.",
      longDescription:
        "Campus Navigator addresses the common challenge of navigating large university campuses efficiently. The application integrates multiple data sources including building layouts, accessibility information, and real-time crowd data to provide optimal routing suggestions. Key features include indoor navigation, event-based routing, and social features that allow students to share popular paths and discover campus amenities.",
      technologies: [
        "React Native",
        "JavaScript",
        "Google Maps API",
    ...
    },
    {
      ...
      description:
        "An AI-powered system for detecting and monitoring social distancing compliance in real-time using computer vision and deep learning technologies. Developed during the COVID-19 pandemic to enhance public safety measures.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "A comprehensive client relationship management system built during my internship at Infi-data Technologies. The platform streamlines client onboarding, project management, and communication workflows.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "A secure web-based credit management system developed during my internship at Sparks Foundation. The system provides real-time transaction monitoring, credit analysis, and comprehensive reporting capabilities.",
      longDescription:
  ...
  const professionalWork = [
    {
      ...
      description:
        "Designed and implemented scalable data pipelines using Apache Airflow to orchestrate ETL processes for operational data from Oracle, SharePoint, and CMMS systems into Azure Data Lake.",
      technologies: [
        "Apache Airflow",
        "Azure Data Lake",
        "Python",
    ...
    },
    {
      ...
      company: "MTA New York City Transit",
      description:
        "Created comprehensive Power BI and Tableau dashboards that translate complex operational data into actionable insights, improving decision-making efficiency by 80%.",
    ...
    },
    {
      ...
      description:
        "Implemented DevOps practices and cloud automation using Docker, Kubernetes, and Terraform across Azure and AWS environments.",
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/projects" className="text-slate-900 font-medium">
                Projects
              </Link>
              <Link
                to="/certifications"
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-slate-600 max-w-3xl">
            A showcase of my academic and professional work, demonstrating
            expertise in full-stack development, data analytics, and innovative
              ...
              >
                <div className="md:flex">
                  <div className="md:w-1/3">
                    <div
                      className={`h-64 md:h-full bg-gradient-to-br ${project.color} flex flex-col items-center justify-center text-white p-6`}
                    >
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="p-6">
              ...
              <p className="text-sm text-slate-600">
                ETL pipelines, data lakes, and analytics platforms
              </p>
            </div>
            <div className="p-6">
              ...
              <p className="text-sm text-slate-600">
                Deep learning, object detection, and image processing
              </p>
            </div>
            <div className="p-6">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-slate-600">
                Azure, AWS, Docker, and automation
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            I'm always looking for exciting projects and opportunities to create
